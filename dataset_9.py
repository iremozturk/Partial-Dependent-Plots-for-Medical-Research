...
def clean_dataset9(file_path):

    cleaned_file_path = "cleaned_dataset_9.csv"

    if not os.path.exists(cleaned_file_path):
        # Perform data cleaning steps if the cleaned dataset doesn't exist
        df = pd.read_csv(r"C:\Users\iremo\PycharmProjects\pythonProject1\heart_attack_prediction_dataset-9.csv")
