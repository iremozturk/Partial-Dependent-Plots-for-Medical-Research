...
def clean_dataset13(file_path):

    cleaned_file_path = "cleaned_dataset_13.csv"

    if not os.path.exists(cleaned_file_path):
        # Perform data cleaning steps if the cleaned dataset doesn't exist
        df = pd.read_csv(r"C:\Users\iremo\PycharmProjects\pythonProject1\COPD_dataset-13.csv")
