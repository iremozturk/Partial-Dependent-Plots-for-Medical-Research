...
def clean_dataset15(file_path):

    cleaned_file_path = "cleaned_dataset_15.csv"

    if not os.path.exists(cleaned_file_path):
        # Perform data cleaning steps if the cleaned dataset doesn't exist
        df = pd.read_csv(r"C:\Users\iremo\PycharmProjects\pythonProject1\Heart_Disease_Prediction-15.csv")
