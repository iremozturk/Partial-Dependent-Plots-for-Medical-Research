...
def clean_dataset22(file_path):

    cleaned_file_path = "cleaned_dataset_22.csv"

    if not os.path.exists(cleaned_file_path):
        # Perform data cleaning steps if the cleaned dataset doesn't exist
        df = pd.read_csv(r"C:\Users\iremo\PycharmProjects\pythonProject1\NYSDOH_CancerMapping_Data_2005_2009-22.csv")
    ...
    X = df.drop(columns=['highlight_Uterus'])
    y = df['highlight_Uterus']
