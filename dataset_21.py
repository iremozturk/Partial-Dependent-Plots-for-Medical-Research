...
def clean_dataset21(file_path):

    cleaned_file_path = "cleaned_dataset_21.csv"

    if not os.path.exists(cleaned_file_path):
        # Perform data cleaning steps if the cleaned dataset doesn't exist
        df = pd.read_csv(r"C:\Users\iremo\PycharmProjects\pythonProject1\Disease_symptom_and_patient_profile_dataset-21.csv")
