...
def clean_dataset8(file_path):

    cleaned_file_path = "cleaned_dataset_8.csv"

    if not os.path.exists(cleaned_file_path):
        # Perform data cleaning steps if the cleaned dataset doesn't exist
        df = pd.read_csv(r"C:\Users\iremo\PycharmProjects\pythonProject1\healthcare_dataset-8.csv")
