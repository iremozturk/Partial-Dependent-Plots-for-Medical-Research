...
def clean_dataset20(file_path):

    cleaned_file_path = "cleaned_dataset_20.csv"

    if not os.path.exists(cleaned_file_path):
        # Perform data cleaning steps if the cleaned dataset doesn't exist
        df = pd.read_csv(r"C:\Users\iremo\PycharmProjects\pythonProject1\dementia_patients_health_data-20.csv")
