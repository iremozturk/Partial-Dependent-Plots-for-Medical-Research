...
def clean_dataset19(file_path):

    cleaned_file_path = "cleaned_dataset_19.csv"

    if not os.path.exists(cleaned_file_path):
        # Perform data cleaning steps if the cleaned dataset doesn't exist
        df = pd.read_csv(r"C:\Users\iremo\PycharmProjects\pythonProject1\healthcare-dataset-stroke-data-19.csv")
