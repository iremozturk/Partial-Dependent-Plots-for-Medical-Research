...
def clean_dataset12(file_path):

    cleaned_file_path = "cleaned_dataset_12.csv"

    if not os.path.exists(cleaned_file_path):
        # Perform data cleaning steps if the cleaned dataset doesn't exist
        df = pd.read_csv(r"C:\Users\iremo\PycharmProjects\pythonProject1\Liver Patient Dataset (LPD)-12.csv")
